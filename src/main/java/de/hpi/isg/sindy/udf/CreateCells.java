...
public class CreateCells extends RichMapFunction<Tuple2<Integer, String>, Tuple2<String, int[]>> {
    ...
    @Override
    public Tuple2<String, int[]> map(final Tuple2<Integer, String> inputTuple)
            throws Exception {

        this.reuseColumnIdentifierArray[0] = inputTuple.f0;
        this.outputTuple.f0 = inputTuple.f1;
