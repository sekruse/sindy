 ...
 */
@ReadFields("0")
public class UnionAttributes extends RichGroupReduceFunction<IntObjectTuple<String>, int[]> {
    ...
    @Override
    public void reduce(final Iterable<IntObjectTuple<String>> bucketElements,
            final Collector<int[]> out) throws Exception {

        this.attributeCollector.clear();
        for (final IntObjectTuple<String> bucketElement : bucketElements) {
            this.attributeCollector.add(bucketElement.a);
        }
