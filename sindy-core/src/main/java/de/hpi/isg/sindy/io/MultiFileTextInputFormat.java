 ...
 */
public class MultiFileTextInputFormat extends DelimitedInputFormat<IntObjectTuple<String>>
        implements ResultTypeQueryable<IntObjectTuple<String>> {
    ...
    @Override
    public IntObjectTuple<String> readRecord(final IntObjectTuple<String> reuse, final byte[] bytes,
                                             final int offset, final int numBytes) {

        reuse.a = this.fileId;
        reuse.b = new String(bytes, offset, numBytes, this.encoding.getCharset());
    ...
    public TypeInformation<IntObjectTuple<String>> getProducedType() {
        // TODO: Does this work?
        return TypeExtractor.getForObject(new IntObjectTuple<>(0, ""));
    }
